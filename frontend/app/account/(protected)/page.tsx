...
function EmptyState({ icon: Icon, title, text }: { icon: typeof FileText; title: string; text: string }) { return <div className="rounded-[1.5rem] border border-dashed border-[#D8D0C0] bg-white px-6 py-10 text-center"><Icon className="mx-auto text-[#1E7A34]" size={28} /><h3 className="mt-3 font-semibold text-[#2E3192]">{title}</h3><p className="mx-auto mt-2 max-w-md text-sm leading-6 text-[#625E55]">{text}</p></div>; }
