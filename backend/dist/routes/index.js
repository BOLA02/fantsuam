...
const application_fee_routes_1 = __importDefault(require("../modules/application-fees/application-fee.routes"));
const savings_1 = __importDefault(require("../modules/savings"));
...
router.use("/application-fee", application_fee_routes_1.default);
