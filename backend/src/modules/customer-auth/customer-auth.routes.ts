...
import { customerLoginSchema, verifiedCustomerSignupSchema } from "./customer-auth.validation";

const router = Router();
router.post("/signup", validate(verifiedCustomerSignupSchema), controller.signup);
